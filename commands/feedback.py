...
from constants.messages import GOODBYE_WE_ARE_SORRY, FEEDBACK_MESSAGE, NEW_MESSAGE, YOUR_MESSAGE_WAS_SENT
...
async def send_feedback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    await context.bot.send_message(
        ...
        text=NEW_MESSAGE.format(user_id=user_id, first_name=first_name,
