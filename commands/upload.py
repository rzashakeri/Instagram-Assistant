...
from instagrapi.exceptions import (ChallengeRequired, ClientError,
                                   ClientForbiddenError, ClipNotUpload,
                                   IGTVNotUpload, LoginRequired,
...
import constants
from constants import BACK, DOCUMENT, LOGIN, NO, PROCESSING, YES
...
from constants.messages import (
    ...
    CAPTION_THAT_IS_GOING_TO_BE_UPLOADED_TO_INSTAGRAM, CHALLENGE_REQUIRED,
    FILE_IS_NOT_VALID, INSTAGRAM_ASSISTANT_ID, LOGGED_IN_SUCCESSFULLY,
    ...
    YOU_NEED_TO_LOGIN_AGAIN, YOU_WERE_ALREADY_LOGGED_IN,
...
async def login_with_two_factor_authentication(
    ...
    try:
        ...
        CLIENT = CustomClient(
            username=USERNAME, password=USERNAME, verification_code=verification_code
        ).get_client(
            login_directory=login_directory,
            telegram_user_id=user_id,
            save_session=False,
