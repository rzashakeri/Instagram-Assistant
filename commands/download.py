...
import validators
from instagrapi.exceptions import (ClientError, InvalidMediaId, MediaNotFound,
...
from constants import (AUDIO_SEGMENT, P_SEGMENT, PROCESSING, REEL_SEGMENT,
                       STORIES_SEGMENT)
...
from constants.messages import (GETTING_MEDIA_INFORMATION,
                                ...
                                GETTING_STORY_INFORMATION,
                                INSTAGRAM_ASSISTANT_ID, INSTAGRAM_COM,
                                LINK_IS_INVALID, MEDIA_CAPTION,
                                MEDIA_NOT_FOUND, MUSIC_DETAILS,
        ...
        if AUDIO_SEGMENT in message:
            ...
            await update.effective_user.send_audio(
                ...
                caption=MUSIC_DETAILS.format(
                    title=music_data["metadata"]["original_sound_info"]["ig_artist"][
                        "full_name"
                    ],
                    artist=music_data["metadata"]["original_sound_info"]["ig_artist"][
                        "username"
                    ],
                ),
                reply_markup=base_keyboard,
