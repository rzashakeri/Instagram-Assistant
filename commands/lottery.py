...
import validators
from instagrapi.exceptions import ClientError, MediaNotFound, PrivateError
...
from constants.messages import (INSTAGRAM_COM, LINK_IS_INVALID,
...
async def lottery_with_likes_list(
    ...
    try:
        ...
        try:
            create_request(
                user_id=update.effective_user.id, request_type=LOTTERY_REQUEST
            )
