...
from constants.keys import DOWNLOAD_KEY, UPLOAD_KEY, INSIGHT_KEY, LOGIN_KEY, BACK_KEY, UPLOAD_REELS_KEY, UPLOAD_PHOTO_KEY, UPLOAD_VIDEO_KEY, UPLOAD_ALBUM_KEY, UPLOAD_IGTV_KEY, BACK_TO_HOME_KEY, SEND_MESSAGE_TO_ALL_USER_KEY, USER_COUNT_KEY, PRIVACY_KEY, LOTTERY_WITH_COMMENTS_LIST, LOTTERY_WITH_LIKES_LIST, LOTTERY_KEY, UPLOAD_STORY_KEY
...
yes_or_no_keyboard = ReplyKeyboardMarkup(
    yes_or_no_reply_keyboard, resize_keyboard=True)
...
admin_keyboard = ReplyKeyboardMarkup(
    admin_reply_keyboard, resize_keyboard=True)
...
lottery_keyboard = ReplyKeyboardMarkup(
    lottery_reply_keyboard, resize_keyboard=True)
